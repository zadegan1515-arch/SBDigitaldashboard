...
const handlers: Record<string, Handler> = {
  ...
  async discoverBrands({ query }: any) {
    ...
    const CATS = 'electrolytes, energy, beverage, rtd, spirits, alcohol, nicotine, athletic, apparel, cpg, tech, fintech, software, beauty, apps, betting, nightlife, wellness, qsr, home, entertainment, retail, transport, conglomerate'
    const prompt = [
