...
export const CATEGORY_KEYS = [
  ...
  'qsr', 'home', 'entertainment', 'retail', 'transport', 'conglomerate',
  'unresolved',
] as const
...
// First match wins, so the order is load-bearing. retail / transport /
// conglomerate come last on purpose: "Retail Apparel and Fashion" is a
// clothing brand, and a store that sells home goods should still read
// "home" — those three only catch what nothing more specific did.
