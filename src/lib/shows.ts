...
const SCHOOL_TABLE = [
  ...
  S('College of Charleston', 'Charleston', 'SC', 'charleston', 'cofc'),
  S('University of Delaware', 'Newark', 'DE', 'delaware', 'udel'),
]
// Campus centre coordinates for the Show Board map, keyed by SCHOOL_TABLE
// name. Public knowledge (the campus, not any venue), so brand-safe.
const CAMPUS_LL: Record<string, [number, number]> = {
  'University of Tennessee': [35.954, -83.93],
  'University of South Carolina': [33.994, -81.03],
  'University of Miami': [25.717, -80.278],
  'Georgia Tech': [33.776, -84.396],
  'University of Oklahoma': [35.206, -97.446],
  'University of Texas': [30.285, -97.734],
  'Wake Forest University': [36.135, -80.278],
  'University of Arkansas': [36.069, -94.175],
  'University of Tampa': [27.946, -82.464],
  'University of Cincinnati': [39.132, -84.515],
  'University of Colorado': [40.008, -105.266],
  'James Madison University': [38.435, -78.869],
  'East Carolina University': [35.607, -77.366],
  'NC State': [35.785, -78.682],
  'Colgate University': [42.819, -75.536],
  'Clemson University': [34.683, -82.837],
  'Auburn University': [32.603, -85.487],
  'University of Arizona': [32.232, -110.95],
  'Arizona State University': [33.424, -111.928],
  'Ole Miss': [34.365, -89.538],
  'SMU': [32.841, -96.784],
  'Michigan State University': [42.701, -84.482],
  'University of Michigan': [42.278, -83.738],
  'University of Georgia': [33.948, -83.377],
  'Florida State University': [30.442, -84.299],
  'University of Florida': [29.644, -82.355],
  'University of South Florida': [28.059, -82.414],
  'University of Wisconsin': [43.077, -89.412],
  'University of Alabama': [33.214, -87.539],
  'San Diego State University': [32.776, -117.072],
  'University of San Diego': [32.772, -117.188],
  'UNC': [35.905, -79.048],
  'LSU': [30.413, -91.18],
  'Tulane University': [29.94, -90.12],
  'Mississippi State': [33.454, -88.789],
  'Indiana University': [39.168, -86.523],
  'USC': [34.022, -118.285],
  'UCLA': [34.069, -118.445],
  'UC Santa Barbara': [34.414, -119.849],
  'Chapman University': [33.793, -117.852],
  'Santa Clara University': [37.349, -121.939],
  'Miami University': [39.512, -84.745],
  'Ohio State University': [40.007, -83.03],
  'Ohio University': [39.324, -82.102],
  'Cornell University': [42.453, -76.473],
  'Syracuse University': [43.038, -76.135],
  'University of Virginia': [38.033, -78.508],
  'Virginia Tech': [37.228, -80.423],
  'Texas Tech': [33.584, -101.875],
  'Texas A&M': [30.615, -96.341],
  'TCU': [32.71, -97.363],
  'University of Washington': [47.655, -122.303],
  'Sewanee': [35.204, -85.921],
  'Georgia Southern': [32.424, -81.783],
  'Georgia College': [33.081, -83.232],
  'University of Missouri': [38.94, -92.328],
  'Bucknell University': [40.955, -76.884],
  'UPenn': [39.952, -75.193],
  'Central Michigan': [43.591, -84.776],
  'Dartmouth College': [43.703, -72.288],
  'Illinois State': [40.51, -88.99],
  'Wofford College': [34.959, -81.935],
  'Duke University': [36.001, -78.938],
  'Western University': [43.009, -81.273],
  "Queen's University": [44.225, -76.495],
  'Wilfrid Laurier': [43.474, -80.527],
  'Baylor University': [31.549, -97.114],
  'University of Kentucky': [38.031, -84.504],
  'Vanderbilt': [36.145, -86.803],
  'Penn State': [40.798, -77.86],
  'Purdue': [40.428, -86.914],
  'University of Iowa': [41.662, -91.55],
  'Kansas': [38.954, -95.255],
  'Oklahoma State': [36.127, -97.074],
  'Ohio Wesleyan': [40.297, -83.068],
  'College of Charleston': [32.784, -79.937],
  'University of Delaware': [39.681, -75.752],
}
...
export function publicShow(s: Show) {
  return { id: s.id, past: s.past, date: s.date, season: s.season, artist: s.artist, type: s.type, performer: performerFor(s), genre: s.genre, school: s.schoolName, schoolShort: s.school, city: s.city, state: s.state, chapter: s.chapter, ll: CAMPUS_LL[s.schoolName] || null }
}
